 ...
 * 
 * 
 * @author Mythe & Omistaja & TamTran
 */
public class CreatedBuildings {
    
    
    // Class that contains created Buildings. Possibly not the final place for the created objects to be.
    
    public void CreatedBuildings(){
